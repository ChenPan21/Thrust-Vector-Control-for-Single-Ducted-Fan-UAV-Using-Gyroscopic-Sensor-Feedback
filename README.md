...
![倒立水瓶](img/r62n2zD.png)  当水瓶开始向左倾斜时，您的手会下意识地向左移动，产生一个反作用力，将水瓶推回中心。当它向右倾斜时，您的手又会向右移动来纠正它。从而实现平衡。

![本项目TVC 原理](img/r62n2zD2.png) 这台无人机的**推力矢量控制**原理与此非常相似。它底部的四个舵面就像您的手，强大的函道风扇产生的气流就像那瓶水。当无人机的陀螺仪传感器（相当于您的眼睛和平衡感）检测到机身发生倾斜时，控制器会立刻命令相应的舵面偏转，改变高速气流的方向。这样，气流就会产生一个反作用力，将机身“推”回平衡状态。
...
* **结构简化:** 仅需1个函道风扇+4个舵机即可实现全姿态控制，简化了机械结构和电子驱动部分，减轻了重量和体积。
